...
namespace CySoft.Utility
{
    public class SystemKey
    {
        ...
        /// 系统内部通讯签名密钥
        /// </summary>
        public static readonly string InternalSignKey = "我是InternalSignKey";


        /// <summary>
        /// Redis 锁 1：启用
        /// </summary>
        public static readonly bool RedisLock_Enable = false;


        /// <summary>
        /// Redis 使用数据库编号
        /// </summary>
        public static readonly int Redis_DB_Num = -1;

        /// <summary>
        /// Redis 缓存键前缀 {Redis_KeyPrefix}:{KEY}
        /// </summary>
        public static readonly string Redis_KeyPrefix = "UnifiedPay";
